...
#This is where the lists for correct answers, the questions and choices are stored.
username = input()
...
while age.isnumeric() == False: 
    print("Invalid, input a whole number.")
    age = input()
age = int(age)
if age > 13:
...
while l<3:
    ...
    while i<3:
        ...
        if  a1 == correcta[qno*2] or a1 == correcta[qno*2+1]:
            #this checks if correct input has been inputted or not
            print ("Correct!") 
            if i ==0: points += 10
            #this checks if the first attempt at the question was right they get 10 points, if it was their second or third they will not receive any points
            break 
        else :
            print("Incorrect") 
        i += 1
    time.sleep(2.5)
    qno += 1 
print("Well done, you earned " + str(points) + " good job!")
